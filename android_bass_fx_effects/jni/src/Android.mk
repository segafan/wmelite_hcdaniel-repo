...
LOCAL_SRC_FILES := ../../../prebuilt/android/$(TARGET_ARCH_ABI)/libbass_fx.so
...
LOCAL_MODULE := effects
LOCAL_SRC_FILES := ../../../prebuilt/android/$(TARGET_ARCH_ABI)/libeffects.so
...
$(LOCAL_PATH)/../../../dependencies/libeffects/ \
...
LOCAL_CPPFLAGS += -fexceptions -frtti -Wno-write-strings -Wno-conversion-null -DUSE_BASS_FX -DUSE_LIBEFFECTS_REVERB
...
LOCAL_SHARED_LIBRARIES := SDL2 freeimage bass bass_fx effects
