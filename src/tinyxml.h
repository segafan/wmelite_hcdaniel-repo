...
public:
	...
	*/
	virtual void Print( FILEHANDLE cfile, int depth ) const = 0;
...
public:
	...
	*/
	...
	virtual void Print( FILEHANDLE cfile, int depth ) const {
		Print( cfile, depth, 0 );
	}
	void Print( FILEHANDLE cfile, int depth, TIXML_STRING* str ) const;
...
public:
	...
	virtual void Print( FILEHANDLE cfile, int depth, TIXML_STRING* str ) const;
	virtual void Print( FILEHANDLE cfile, int depth ) const {
		Print( cfile, depth, 0 );
	}
...
public:
	...
	*/
	bool LoadFile( FILEHANDLE, TiXmlEncoding encoding = TIXML_DEFAULT_ENCODING );
	/// Save a file using the given FILE*. Returns true if successful.
	bool SaveFile( FILEHANDLE ) const;
...
//		return ( f.buffer && SaveFile( f.buffer ));
	...
	*/
	...
	virtual void Print( FILEHANDLE cfile, int depth = 0 ) const;
	// [internal use]
